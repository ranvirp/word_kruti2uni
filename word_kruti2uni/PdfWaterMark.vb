...
Public Class PdfWaterMark
    ...
    End Sub
    Public Shared Sub AddPDFWatermark(ByVal pdfSource As FileStream, ByVal pdfDest As FileStream, ByVal imgSource As String)
        ...
        Try
            pdfFileReader = New PdfReader(pdfSource) 'Read File

            rctRect = pdfFileReader.GetPageSizeWithRotation(1) 'Store Page Size

            psStamp = New PdfStamper(pdfFileReader, pdfDest) 'Create new Stamper Object
